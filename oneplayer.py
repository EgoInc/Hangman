...
class OnePlayerApp(QtWidgets.QMainWindow, design.Ui_MainWindow):
    ...
    def setword(self):
        ...
        WORD = random.choice(open("words.txt", 'r').read().splitlines())
    ...
    def main():
        ...
        window = OnePlayerApp()  # Создаём объект класса OnePlayerApp
